...
function draw_today_map() {
  ...
  L.tileLayer(
    "https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}",
    {
      ...
      accessToken:
        "pk.eyJ1IjoiaGFuc2hlbnJpayIsImEiOiJjaWo0aTAzdncwMDIwdXJrcm5jZDZ6dXJ4In0.00I3RVVHNDAvi0XnbZEU-Q",
      tileSize: 512,
      zoomOffset: -1,
      id: "mapbox/streets-v11", // Or one of these: https://www.mapbox.com/developers/api/maps/#tiles
    }
  ).addTo(today_map);
...
function draw_future_map() {
  ...
  for (i = 0; i < 200; i++) {
    ...
    L.circleMarker([lat, lon], {
      ...
      .addTo(future_map)
      .bindPopup(
        "<b>Node X</b><br><b>Latest CO2 level</b>: " +
          value +
          "<br><b>Time</b>: 2016-01-07T17:04:42.453Z"
      )
  ...
  function onMapClick(e) {
    popup
      .setLatLng(e.latlng)
      .setContent(
        "<a href='#'>Request drone measurement</a> at this location<br><a href='#'>Request permanent sensor</a> at this location"
      ) //+ e.latlng.toString())
      .openOn(future_map);
  }
